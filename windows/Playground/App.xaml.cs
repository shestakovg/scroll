// -----------------------------------------------------------------------
// <copyright file="App.xaml.cs" company="BlueJeans Network, Inc.">
...
namespace Playground
{
    ...
    {
        private readonly AppReactPage reactPage = new AppReactPage();
        ...
        private void OnCreate(string[] arguments)
        {
            ...
            if (rootFrame == null)
            {
                this.reactPage.OnCreate(arguments);
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                rootFrame.Content = this.reactPage;
            }
